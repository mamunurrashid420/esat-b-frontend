  ...
  return (
    <>
      ...
      <div className="p-6 border-b border-gray-200">
        ...
        >
          <div className="w-12 h-12 rounded-full border-2 bg-white flex items-center justify-center shrink-0 overflow-hidden" style={{ borderColor: 'var(--color-primary)' }}>
            <img 
              src={logoImage} 
              alt="ESAT-B Logo" 
          ...
          <div className="flex-1">
            <h2 className="text-xs font-semibold leading-tight" style={{ color: 'var(--color-primary)' }}>
              EX-STUDENTS ASSOCIATION OF
            </h2>
            <h3 className="text-xs font-semibold leading-tight" style={{ color: 'var(--color-primary)' }}>
              ...
              <li key={item.href}>
                <Link
                  ...
                  className={cn(
                    ...
                    isActive ? 'font-medium bg-blue-50' : 'text-black hover:bg-gray-50'
                  )}
                  style={isActive ? { color: 'var(--color-primary)' } : undefined}
                >
                  {isActive && (
                    <div className="absolute left-0 top-0 bottom-0 w-1 rounded-r-full" style={{ backgroundColor: 'var(--color-primary)' }} />
                  )}
